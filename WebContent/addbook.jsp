				...
				<div class="panel panel-default">
					<div class="panel-body tabs">
						<ul class="nav nav-tabs">
							<li><a href="#tab1" data-toggle="tab">图书更新</a></li>
							<li  class="active"><a href="#tab2" data-toggle="tab">新增图书</a></li>
						...
						<div class="tab-content">
						     ...
						     <form class="form-horizontal" action="updatebook" method="post" > <!-- onsubmit="return validcheck(this)" -->
								...
								<!-- ISBN input-->
								  <div class="form-group">
									...
									<div class="col-md-9">
										<input id="ISBN" name="isbn" type="text" placeholder="输入ISBN,形如xxx-x-xxx-xxxxx-x" class="form-control">
									</div>
								 </div>
								...
								<div class="form-group">
									<div class="col-md-12 widget-right">
										<button type="submit" class="btn btn-default btn-md pull-right" name="submitstate" value="search">Search</button>
										<button type="submit" class="btn btn-default btn-md pull-right mymargin1" name="submitstate" value="submit">Submit</button>
						   ...
						   <script language="javascript">
							...
							<div class="tab-pane fade in active" id="tab2">
								...
								<div class="form-group">
									<div class="col-md-12 widget-right">
										<button type="submit" class="btn btn-default btn-md pull-right" name="addbutton" value="add">Add</button>
										<button type="reset" class="btn btn-default btn-md pull-left">Reset</button>
									</div>
